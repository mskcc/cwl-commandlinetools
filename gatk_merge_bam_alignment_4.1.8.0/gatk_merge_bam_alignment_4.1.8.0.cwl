...
inputs:
  ...
  - id: add_mate_cigar
    ...
    doc: |
      Adds the mate CIGAR tag (MC) if true, does not if false.  Default value: true. Possible
      values: {true, false}
  ...
  - id: aligned_bam
    ...
    inputBinding:
      position: 1
    doc: |
      SAM or BAM file(s) with alignment data.  This argument may be specified 0 or more times.
  ...
  - id: aligned_reads_only
    ...
    doc: |
      Whether to output only aligned reads. Default value: false. Possible values: {true,
      false}
  - id: aligner_proper_pair_flags
    ...
    doc: |
      Use the aligners idea of what a proper pair is rather than computing in this program.
  ...
  - id: clip_adapters
    ...
    doc: |
      Whether to clip adapters where identified.  Default value: true. Possible values: {true,
      false}
  ...
  - id: jump_size
    ...
    inputBinding:
      ...
      prefix: --JUMP_SIZE
    doc: |
      The expected jump size (required if this is a jumping library). Deprecated. Use
  ...
  - id: paired_run
    ...
    inputBinding:
      ...
      prefix: --PAIRED_RUN
    doc: |
      DEPRECATED. This argument is ignored and will be removed.  Default value: true. Possible
      values: {true, false}
  ...
  - id: sort_order
    ...
    inputBinding:
      ...
      prefix: --SORT_ORDER
    doc: |
      The order in which the merged reads should be output.  Default value: coordinate. Possible
